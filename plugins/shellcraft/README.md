...
2. Bootstrap your project: `/shellcraft bootstrap`
...
The bash-developer writes production scripts following all shellcraft conventions. The bash-code-reviewer provides actionable feedback with severity levels (P0/P1/P2) and fixability indicators. The bash-test-writer generates bats test suites with setup/teardown isolation and selective mocking patterns.
...
**Invocation:** `/shellcraft bootstrap`
...
**Location:** `plugins/shellcraft/templates/`
