---
description: Copy bark project templates (CLAUDE.md, Makefile, .shellcheckrc) to current directory
allowed-tools: Read, Write, Bash, Glob
---

# Bootstrap Bark Project

Copy the bark project templates to the current working directory. Templates provide a ready-to-use project setup with conventions, lint config, and build targets.
...
- **CLAUDE.md**: If it already exists, APPEND the template content at the end with a separator:
  ```
  # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  #   BARK CONVENTIONS (appended by bootstrap)
  # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ```
