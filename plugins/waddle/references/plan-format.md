...
Plan files live in `.waddle/plans/NNN-<slug>.md` where NNN is a zero-padded sequential number.

## Numbering

Read existing plans in `.waddle/plans/`, take the highest NNN, increment by 1. First plan is 001.
...
- `status` field is updated by the waddle command as work progresses
